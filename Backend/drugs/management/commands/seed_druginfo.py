...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # This allows us to re-run the script without re-fetching data.
        ...
        for i, drug in enumerate(drugs_to_fetch):
            ...
            params = {
                'search': f'openfda.brand_name:"{drug.name}" OR openfda.generic_name:"{drug.name}"',
                'limit': 1
            }
            ...
            try:
                ...
                if response.status_code == 200 and response.json().get('results'):
                    ...
                    # Safely get data from the JSON response. Use .get() to avoid errors if a key is missing.
                    ...
                    # Use update_or_create to add or update the DrugInfo for the drug.
